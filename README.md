...
3. Recalibrate the gimbal — just the **normal gimbal auto-calibration in the DJI Fly app** (on
   the remote controller or your phone), exactly like usual. On the service firmware it actually
   rewrites the calibration instead of doing nothing.
